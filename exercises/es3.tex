                ...
                \item $(\implies)$ \vspace{0.2cm} \\
                    ...
                    \begin{itemize}
                        ...
                        \item inductive case $k+1$ \vspace*{-0.3cm}
                            ...
                            \begin{gather*}
                                k_1 + k_2 = k \qquad\qquad \instr{S}{s} \Rightarrow^{k_1} s'' \\
                            ...
                            \begin{itemize}
                                ...
                                \item $\Bool{b} s'' = \text{tt}$
                                    \begin{align*}
                                        ...
                                        \\&\qquad\Rightarrow \instr{\wif{\neg b}{skip}{S_r}; \wwhile{b}{S_r}}{s''}
                                    \end{align*}
                                    Since $\instr{S; \wwhile{b}{S}}{s''} \Rightarrow^{k_2 - 2} s'$ and $k_2 - 2 = k - k_1 - 2 \leq k$ the inductive hypothesis holds and thus $\instr{S_r; \wwhile{b}{S_r}}{s''} \Rightarrow^* s'$
                            \end{itemize}
                    \end{itemize}
                        ...
                        \begin{itemize}
                            ...
                            \item $\Bool{b} s'' = \text{tt}$
                                \begin{align*}
                                    ...
                                    \\&\qquad\Rightarrow \instr{S; \wwhile{b}{S}}{s''}
                                \end{align*}
                                Since $\instr{S_r; \wwhile{b}{S_r}}{s''} \Rightarrow^{k_2 - 1} s'$ and $k_2 - 1 = k - k_1 - 2 \leq k$ the inductive hypothesis holds and thus $\instr{S; \wwhile{b}{S}}{s''} \Rightarrow^* s'$
                        \end{itemize}
                    \end{itemize}
            \end{itemize}
    \end{itemize}
